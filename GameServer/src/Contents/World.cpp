...
void World::GetMonsterInfoContainedInSector(BasePlayer* player, std::vector<Monster*>& otherMonsters)
{
	std::vector<Sector*> aroundSectors;
	GetAroundSector(player, &aroundSectors);
